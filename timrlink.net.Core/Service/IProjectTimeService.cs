...
namespace timrlink.net.Core.Service
{
    ...
    {
        Task<IList<API.ProjectTime>> GetProjectTimes(DateTime? start = null, DateTime? end = null, DateTime? lastModified = null, IEnumerable<API.ProjectTimeStatus> statuses = null, string externalUserId = null, string externalTaskId = null, bool? includeChildTasks = null);
